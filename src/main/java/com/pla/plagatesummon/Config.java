    ...
    static {
        GATES = BUILDER.comment("A list of gates to be spawned with attributes")
                .defineList("gates", List.of(
                        ...
                        List.of("pla:bellringer_gate", "#71955B", "The Bellringer will be awakened", "With every toll, the air grows heavier, and your fate draws near. Face it, or be swallowed by the sound of doom!", "Bellringer Gate"),
                        ...
                        List.of("pla:ent_gate", "#228B22", "Ancient nature will awaken", "The forest will rise, and its guardians will walk once more. Will you stand with nature or be crushed beneath its roots?", "Ent Gate"),
                        ...
                        List.of("pla:guanlet_gate", "#71955B", "Something has escaped from the Nether and will arrive", "Its fiery wrath will consume everything in its path. Will you stand against it or burn to ashes?", "Guanlet Gate"),
                        List.of("pla:herobrine_gate_1", "#800080", "Dark forces will rise", "Herobrine will collect every soul he meets. Stay in the light, or be lost to the darkness!", "Herobrinne Gate"),
                        List.of("pla:herobrine_gate_2", "#800080", "Dark forces will rise", "Herobrine will collect every soul he meets. Stay in the light, or be lost to the darkness!", "Herobrinne Gate"),
                        List.of("pla:herobrine_gate_3", "#800080", "Dark forces will rise", "Herobrine will collect every soul he meets. Stay in the light, or be lost to the darkness!", "Herobrinne Gate"),
                        List.of("pla:herobrine_gate_4", "#800080", "Dark forces will rise", "Herobrine will collect every soul he meets. Stay in the light, or be lost to the darkness!", "Herobrinne Gate"),
                        List.of("pla:herobrine_gate_5", "#800080", "Dark forces will rise", "Herobrine will collect every soul he meets. Stay in the light, or be lost to the darkness!", "Herobrinne Gate"),
                        List.of("pla:herobrine_gate_6", "#800080", "Dark forces will rise", "Herobrine will collect every soul he meets. Stay in the light, or be lost to the darkness!", "Herobrinne Gate"),
                        List.of("pla:herobrine_gate_7", "#800080", "Dark forces will rise", "Herobrine will collect every soul he meets. Stay in the light, or be lost to the darkness!", "Herobrinne Gate"),
                        List.of("pla:herobrine_gate_8", "#800080", "Dark forces will rise", "Herobrine will collect every soul he meets. Stay in the light, or be lost to the darkness!", "Herobrinne Gate"),
                        List.of("pla:herobrine_gate_9", "#800080", "Dark forces will rise", "Herobrine will collect every soul he meets. Stay in the light, or be lost to the darkness!", "Herobrinne Gate"),
                        ...
                        List.of("pla:lich_gate", "#800080", "The Lich will rise!", "It will fly through the skies, casting dark spells from above—prepare your bow, or be doomed from afar!", "Lich Gate"),
