    ...
    static {
        GATES = BUILDER.comment("A list of gates to be spawned with attributes")
                .defineList("gates", List.of(
                        ...
                        List.of("pla:gauntlet_gate", "#71955B", "Something has escaped from the Nether and will arrive", "Its fiery wrath will consume everything in its path. Will you stand against it or burn to ashes?", "Gauntlet Gate"),
